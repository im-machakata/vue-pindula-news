  ...
  <footer class="text-center text-white page-footer">
    <div class="container px-6 pt-6">
      <div class="mb-6 flex justify-center">
        ...
        <a href="//github.com/im-machakata" type="button" class="social-link">
          <i class="fab fa-github" aria-hidden="true"></i>
        </a>
      </div>
    </div>
    <div class="p-4 text-center" style="background-color: rgba(0, 0, 0, 0.2)">
      <p>Learn something new everyday. Designed by <a href="//github.com/im-machakata" target="_blank"
          class="hover:underline">Isaac Machakata</a></p>
    </div>
  </footer>
</template>
<script>
