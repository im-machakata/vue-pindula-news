<template>
  <p v-show="news.length < 1" class="text-white mt-5 px-3">Hie! I get our news from <a href="//zero.pindula.co.zw">pindula</a> using a proxy so please give me a few seconds to get the latest news.</p>
  <section class="news-list">
    <div v-for="item in news"
      ...
      <div class="px-3 pb-4 pt-3 bg-blue-900 rounded-b mt-0">
        <a class="news-title" href="item.canonical" target="_blank">{{ item.title }}</a>
